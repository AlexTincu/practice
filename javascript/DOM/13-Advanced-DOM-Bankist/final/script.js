...
// HTML collections, live objects
// const buttons = document.querySelectorAll('.btn--show-modal');
// const buttons = document.getElementsByClassName('btn--show-modal');
...
// crearea unui element si adaugarea lui la html
const message = document.createElement('div');
// message.textContent = 'We store cookies.'; // set text
message.innerHTML = 'We store cookies. <button class="btn">Close</button>'; // set html

message.classList.add('cookie-message'); // add class
message.style.setProperty('padding', '10px'); // set a css property
message.style.setProperty('background-color', 'blue');

// adaugarea unui element intr-un alt element
document.querySelector('.header').prepend(message); // la inceput
// document.querySelector('.header').append(message); // la final

// clonarea si adaugare
...
img.setAttribute('designer', 'M K Camilla');
img.setAttribute('data-logo', 'Logo');
const designer = img.getAttribute('designer');
